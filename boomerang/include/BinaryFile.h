...
enum LOAD_FMT { LOADFMT_ELF, LOADFMT_PE, LOADFMT_PALM, LOADFMT_PAR,
	LOADFMT_EXE, LOADFMT_MACHO, LOADFMT_LX, LOADFMT_COFF };
enum MACHINE { MACHINE_PENTIUM, MACHINE_SPARC, MACHINE_HPRISC,
	MACHINE_PALM, MACHINE_PPC, MACHINE_ST20, MACHINE_MIPS };
...
class IMPORT_BINARYFILE BinaryFile {
  ...
  public:
     ...
     virtual ~ BinaryFile() {
									...
									// General loader functions BinaryFile(bool bArchive = false);
									// Constructor
...
// Symbol table functions
    ...
    virtual ADDRESS GetAddressByName(const char *pName, bool bNoTypeOK =
				     false);
    ...
    virtual std::vector < ADDRESS > GetExportedAddresses(bool funcsOnly =
							 true) {
...
// Internal information
    ...
    virtual std::list < SectionInfo * >&GetEntryPoints(const char *pEntry =
						       "main") = 0;
