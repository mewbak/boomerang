...
bool ExeBinaryFile::RealLoad(const char* sName) {
    ...
    m_pSections[0].uHostAddr = *reinterpret_cast<DWord *>(m_pHeader);
    ...
    m_pSections[1].uHostAddr = *reinterpret_cast<DWord *>(m_pImage);
    ...
    m_pSections[2].uHostAddr = *reinterpret_cast<DWord *>(m_pRelocTable);
